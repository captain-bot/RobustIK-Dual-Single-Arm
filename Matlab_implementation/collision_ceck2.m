...
% Circle radius
peg_radius = 0.020; hole_radius = 0.030;
peg_height = 0.050;  hole_height = 0.050;
...
peg_positionNew1 = peg_positionOld1*left_hole_R;
peg_positionNew2 = peg_positionOld2*left_hole_R;
...
right_gripper = right_hole_p - hole_height*right_hole_R(:,3);
...
quiver3(0, 0, 0, 1, 0, 0, 0.05, 'linewidth', 2, 'color', 'r')
quiver3(0, 0, 0, 0, 1, 0, 0.05, 'linewidth', 2, 'color', 'g')
quiver3(0, 0, 0, 0, 0, 1, 0.05, 'linewidth', 2, 'color', 'b')
...
left_gripper = left_peg_p - peg_height*left_hole_R(:,3);
...
for i = 1:100
    ...
    draw_peg_x = quiver3(left_peg_p(1), left_peg_p(2), left_peg_p(3), left_hole_R(1, 1), left_hole_R(2, 1), left_hole_R(3, 1), 0.05, 'linewidth', 2, 'color', 'r');
    draw_peg_y = quiver3(left_peg_p(1), left_peg_p(2), left_peg_p(3), left_hole_R(1, 2), left_hole_R(2, 2), left_hole_R(3, 2), 0.05, 'linewidth', 2, 'color', 'g');
    draw_peg_z = quiver3(left_peg_p(1), left_peg_p(2), left_peg_p(3), left_hole_R(1, 3), left_hole_R(2, 3), left_hole_R(3, 3), 0.05, 'linewidth', 2, 'color', 'b');
...
%     draw_peg_cyn = surf(peg_new_cyn.x, peg_new_cyn.y, peg_new_cyn.z, "EdgeColor", "none", "FaceAlpha",  1.0, "FaceColor", "r", "FaceLighting", "gouraud");
    ...
    left_gripper = left_gripper + peg_linear_velocity*left_hole_R(:, 3);
    
    % Update left gripper peg's frame position
    left_peg_p = left_peg_p + peg_linear_velocity*left_hole_R(:, 3);
    
    % Update peg's circular face's position
    rotated_circ_left = rotated_circ_left + peg_linear_velocity*left_hole_R(:, 3);
